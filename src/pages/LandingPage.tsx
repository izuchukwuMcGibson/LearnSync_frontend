...
export const LandingPage = () => {
  ...
  return (
    <main className='relative min-h-screen w-full bg-white font-inter text-slate-900 selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden'>
        ...
        <div className='mx-auto max-w-7xl px-6 py-3.5'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-4 sm:gap-6'>
              ...
              <motion.div
                whileHover={{ scale: 1.03, boxShadow: "0 8px 18px -4px rgba(17, 34, 64, 0.25)" }}
                whileTap={{ scale: 0.97 }}
          ...
          <div className='grid lg:grid-cols-12 gap-10 lg:gap-8 items-center'>
            ...
            >
              ...
              <p className='text-sm sm:text-base text-slate-500 mb-8 leading-relaxed font-normal'>
                Transform dense lecture slides, messy GitHub repos, and textbook chapters into
                adaptive active-recall drills and interconnected concept graphs.
              </p>

              {/* CTA Button Row */}
              <div className='flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 mb-8'>
                <motion.div
                  whileHover={{ scale: 1.03, boxShadow: "0 10px 22px -3px rgba(17, 34, 64, 0.3)" }}
                  whileTap={{ scale: 0.97 }}
              ...
              <div className='flex items-center gap-3 text-xs text-slate-500 pt-3 border-t border-slate-200/60'>
                ...
                <span>Trusted by 4,500+ students across UNILAG, Covenant, UI, Ashesi, UCT, Stanford & MIT</span>
              </div>
            </motion.div>
            ...
            >
              <div className='relative mx-auto max-w-lg lg:max-w-none'>
                ...
                <div className='bg-[#0d1527] rounded-2xl border border-slate-700/60 shadow-2xl p-4 sm:p-5 text-white font-mono relative overflow-hidden'>
                  ...
                  <div className='grid grid-cols-3 gap-2 sm:gap-3 mb-4 font-sans'>
                    <div className='bg-slate-800/80 border border-slate-700/50 p-2 sm:p-2.5 rounded-xl'>
                      ...
                      <div className='text-sm sm:text-base font-extrabold text-emerald-400'>94%</div>
                      <div className='text-[10px] text-emerald-400/80 font-medium'>+18% vs avg</div>
                    </div>
                    <div className='bg-slate-800/80 border border-slate-700/50 p-2 sm:p-2.5 rounded-xl'>
                      <div className='text-[10px] text-slate-400 font-bold uppercase tracking-wider'>AVG RECALL</div>
                      <div className='text-sm sm:text-base font-extrabold text-blue-400'>3.4 s</div>
                      <div className='text-[10px] text-slate-400 font-medium'>optimal response</div>
                    </div>
                    <div className='bg-slate-800/80 border border-slate-700/50 p-2 sm:p-2.5 rounded-xl'>
                      <div className='text-[10px] text-slate-400 font-bold uppercase tracking-wider'>TOPIC RANK</div>
                      <div className='text-sm sm:text-base font-extrabold text-amber-400'>TOP 3%</div>
                      <div className='text-[10px] text-slate-400 font-medium'>percentile score</div>
                    </div>
                  </div>
                  ...
                  <div className='bg-[#080d19] p-3.5 rounded-xl border border-slate-800 text-xs sm:text-sm font-mono leading-relaxed mb-4 overflow-x-auto'>
                    <div className='text-slate-500'># Dijkstra's shortest path algorithm</div>
                    <div>
                      <span className='text-purple-400'>def</span>{" "}
                      <span className='text-blue-400'>dijkstra</span>(graph, start):
                    </div>
                    <div className='pl-4'>
                      distances = &#123;node: <span className='text-amber-400'>float</span>(<span className='text-emerald-400'>'infinity'</span>) <span className='text-purple-400'>for</span> node <span className='text-purple-400'>in</span> graph&#125;
                    </div>
                    <div className='pl-4'>distances[start] = <span className='text-cyan-400'>0</span></div>
                    <div className='pl-4 text-emerald-300'>
                      pq = [(<span className='text-cyan-400'>0</span>, start)]  <span className='text-slate-500'># (cost, node) min-heap</span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div>
                    <div className='text-[11px] font-bold text-slate-900'>Knowledge Gap Found</div>
                    <div className='text-[10px] text-slate-500'>Review: Bellman-Ford for negative edge weights</div>
                  </div>
                </motion.div>
              </div>
            </motion.div>
      ...
      <section className='w-full bg-white py-9 border-b border-slate-100'>
        <div className='mx-auto max-w-7xl px-6 text-center'>
          <p className='text-[10px] font-extrabold text-slate-400 uppercase tracking-[0.2em] mb-6'>
            TRUSTED BY CS &amp; ENGINEERING STUDENTS ACROSS TOP AFRICAN &amp; GLOBAL INSTITUTIONS
          </p>
        ...
        <div className='mx-auto max-w-7xl px-6'>
          ...
          >
            ...
            <p className='text-xs sm:text-sm text-slate-500 leading-relaxed font-normal'>
              Move beyond passive rereading. Our three-stage cognitive architecture turns raw course material into permanent, exam-ready intuition.
            </p>
          </motion.div>
      ...
      <section id='features' className='py-16 lg:py-24 bg-white border-y border-slate-100'>
        <div className='mx-auto max-w-7xl px-6'>
          <div className='flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4'>
            <div>
              ...
              <p className='text-xs sm:text-sm text-slate-500 max-w-xl font-normal'>
                No rigid, one-size-fits-all curricula. Every benchmark drill and concept breakdown is generated by AI directly from your personal lecture notes, slides, and code—analyzing topics in a broader conceptual view.
              </p>
            </div>
          ...
          <div className='grid lg:grid-cols-12 gap-6'>
            ...
            >
              <div>
                ...
                <p className='text-xs sm:text-sm text-slate-500 mb-5 leading-relaxed'>
                  Instead of standard superficial flashcards, LearnSync creates rigorous problem-solving prompts with real code execution, complexity analysis, and edge-case testing.
                </p>
                ...
                <div className='bg-slate-50 rounded-xl border border-slate-200 p-4 font-sans mb-4'>
                  <div className='flex items-center justify-between text-xs text-slate-500 pb-2.5 border-b border-slate-200/70 mb-3'>
                    <span className='font-semibold'>Question 3 of 12 • Trees / Heap</span>
                  ...
                  <p className='text-xs sm:text-sm font-semibold text-slate-800 mb-3 leading-relaxed'>
                    Given a Min-Heap with 14 elements, what is the maximum possible height (number of edges from root to deepest node) in this tree?
                  </p>

                  <div className='grid grid-cols-2 gap-2 text-xs'>
                    {[
                      { label: "A", val: "3" },
                      { label: "B", val: "3 (floor(log₂(14)) = 3)", correct: true },
                      { label: "C", val: "4" },
                      { label: "D", val: "2" },
                    ].map((opt, idx) => (
                      <div
                      ...
                      >
                        <span>
                          <span className='text-slate-400 mr-1.5 font-bold'>{opt.label}.</span>
                          {opt.val}
                        </span>
              ...
              <div className='flex items-center justify-between text-[11px] text-slate-400 pt-3 border-t border-slate-100'>
                ...
                <span className='text-emerald-600 font-bold'>⚡ 28 revision questions</span>
              </div>
            </motion.div>
            ...
            >
              <div>
                ...
                <p className='text-xs sm:text-sm text-slate-500 mb-4 leading-relaxed'>
                  Native comprehension of Python, C++, Java, Rust, and SQL. Automatically detects logic flow, algorithmic invariants, and function dependencies.
                </p>
                ...
                <div className='bg-[#0f172a] text-slate-200 p-3.5 rounded-xl font-mono text-xs leading-relaxed border border-slate-700/60 mb-3'>
                  <div className='text-purple-400'>def <span className='text-blue-400'>heapify</span>(arr, n, i):</div>
                  <div className='pl-3 text-slate-300'>largest = i</div>
                  <div className='pl-3 text-slate-300'>l = 2 * i + 1; r = 2 * i + 2</div>
                  <div className='text-emerald-400 text-[10px] pt-1'># Dynamic graph analysis ✓</div>
                </div>
              </div>
            ...
            >
              <div>
                ...
                <p className='text-xs sm:text-sm text-slate-500 mb-4 leading-relaxed'>
                  Forecast exam preparedness accurately. See which topics require urgent attention before finals.
                </p>
                ...
                <div className='bg-slate-50 p-3 rounded-xl border border-slate-200 font-sans mb-3'>
                  <div className='flex items-center justify-between text-[10px] text-slate-500 mb-2'>
                    ...
                    <span className='text-blue-600 font-bold'>+Effective Retention</span>
                  </div>
                  <svg className='w-full h-16' viewBox='0 0 300 70'>
                    ...
                    <path d='M 10 20 Q 150 55 290 60' fill='none' stroke='#f87171' strokeWidth='2' strokeDasharray='4 4' />
                    {/* Blue line: active mastery retention */}
                    <path d='M 10 50 Q 100 45 180 25 T 290 12' fill='none' stroke='#2563eb' strokeWidth='2.5' />
                  </svg>
                </div>
              </div>

              <div className='text-[11px] text-slate-400 pt-3 border-t border-slate-100'>
                <span>Voted top CS study tool at 40+ engineering departments</span>
              </div>
            </motion.div>
            ...
            >
              <div>
                ...
                <p className='text-xs sm:text-sm text-slate-500 mb-4 leading-relaxed'>
                  Upload your personal lecture slides, handwritten notes, markdown files, or codebases. The AI understands the broader subject context and converts raw notes into tailored recall drills.
                </p>
                ...
                <div className='space-y-2.5 font-sans mb-4'>
                  <div>
                    <div className='flex justify-between text-xs font-semibold text-slate-700 mb-1'>
                      ...
                      <span className='text-emerald-600 font-bold'>84% Exam Ready</span>
                    </div>
                  ...
                  <div>
                    <div className='flex justify-between text-xs font-semibold text-slate-700 mb-1'>
                      ...
                      <span className='text-blue-600 font-bold'>68% Active</span>
                    </div>
                    <div className='h-2 bg-slate-100 rounded-full overflow-hidden'>
                  ...
                  <div>
                    <div className='flex justify-between text-xs font-semibold text-slate-700 mb-1'>
                      ...
                      <span className='text-amber-600 font-bold'>42% Needs Review</span>
                    </div>
                    <div className='h-2 bg-slate-100 rounded-full overflow-hidden'>
              ...
              <div className='flex items-center justify-between text-[11px] text-slate-400 pt-3 border-t border-slate-100'>
                ...
                <span className='text-blue-600 font-bold'>Universal Note &amp; Material Synthesis Active &rarr;</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id='demo' className='py-16 lg:py-24 bg-[#f8fafc]/70'>
        <div className='mx-auto max-w-7xl px-6'>
          ...
          >
            ...
            <p className='text-xs sm:text-sm text-slate-500 leading-relaxed font-normal'>
              Shift from low-yield 3-hour study blocks to 45 minutes of high-yield active cognitive retention.
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
              ...
              <div>
                ...
                <div className='space-y-4 text-xs sm:text-sm text-slate-600'>
                  <div className='flex items-start gap-3'>
                    <span className='text-rose-500 font-bold text-base flex-shrink-0'>✕</span>
                    <div>
                      <strong className='text-slate-800'>Passive rereading:</strong> Reading notes repeatedly creates the illusion of competence without building recall.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-rose-500 font-bold text-base flex-shrink-0'>✕</span>
                    <div>
                      <strong className='text-slate-800'>Generic flashcards:</strong> Static Q&amp;A cards with binary answers fail to build relational intuition.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-rose-500 font-bold text-base flex-shrink-0'>✕</span>
                    <div>
                      <strong className='text-slate-800'>No code execution:</strong> Memorizing syntax from lecture slides collapses when faced with actual problem-solving.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-rose-500 font-bold text-base flex-shrink-0'>✕</span>
                    <div>
                      <strong className='text-slate-800'>Cram &amp; Forget:</strong> Retaining only 15% of material one week post-exam; struggling in future prerequisite classes.
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div>
                ...
                <div className='space-y-4 text-xs sm:text-sm text-slate-600'>
                  <div className='flex items-start gap-3'>
                    ...
                    <div>
                      <strong className='text-slate-900'>Cognitive Active Recall:</strong> Interleaved retrieval testing with immediate line-by-line feedback calibration.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-emerald-600 font-bold text-base flex-shrink-0'>✓</span>
                    <div>
                      <strong className='text-slate-900'>Dynamic Question Difficulty:</strong> Questions recalibrate based on your confidence and zero in on weak areas.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-emerald-600 font-bold text-base flex-shrink-0'>✓</span>
                    <div>
                      <strong className='text-slate-900'>Contextual Knowledge Graphs:</strong> Ties algorithms, data structures, and theory into a coherent mental framework.
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-3'>
                    <span className='text-emerald-600 font-bold text-base flex-shrink-0'>✓</span>
                    <div>
                      <strong className='text-slate-900'>Spaced Memory Retention:</strong> Scientifically scheduled review cadences guarantee high long-term retention.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='mt-8 pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-600 font-semibold'>
                ...
                <span className='text-emerald-600 font-bold'>Retention: ~91%</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section id='notes-engine' className='py-16 lg:py-20 bg-white border-b border-slate-100'>
        <div className='mx-auto max-w-7xl px-6 text-center'>
          <span className='inline-block text-[11px] font-extrabold uppercase tracking-widest text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-100 mb-2'>
          ...
          <p className='text-xs sm:text-sm text-slate-500 max-w-2xl mx-auto mb-10'>
            LearnSync isn't locked to predetermined institutional syllabi. Powered by contextual AI, it reads your personal lecture notes, slides, and code repositories—synthesizing concepts in a broader, holistic view tailored to how you study.
          </p>

          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 max-w-5xl mx-auto'>
            {[
              { icon: <FiTerminal className='w-5 h-5 text-blue-600' />, title: "Algorithms" },
              { icon: <FiDatabase className='w-5 h-5 text-emerald-600' />, title: "Data Systems" },
              { icon: <FiCpu className='w-5 h-5 text-indigo-600' />, title: "Architecture" },
              { icon: <FiLayers className='w-5 h-5 text-purple-600' />, title: "Operating Systems" },
              { icon: <FiGlobe className='w-5 h-5 text-amber-600' />, title: "Networking" },
              { icon: <FiAward className='w-5 h-5 text-rose-600' />, title: "AI & Machine Learning" },
            ].map((sub, idx) => (
              <motion.div
                key={idx}
      ...
      {/* Real CS Students. Real Top Percentiles. (Testimonials) */}
      <section className='py-16 lg:py-24 bg-[#f8fafc]/60'>
        <div className='mx-auto max-w-7xl px-6'>
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className='text-xs sm:text-sm text-slate-500 leading-relaxed font-normal'>
              See how computer science students crushed their exam curves and secured top-tier software engineering offers.
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            {[
              {
                quote: "Our lecturers give dense 80-page slides packed with complex theory. LearnSync ingests my raw notes and PDF handouts, understands the broader subject view, and builds active recall drills that match actual exam questions. Scored top 3% in my cohort.",
                name: "Chinedu Okafor",
              ...
              {
                quote: "There is no rigid curriculum you're forced to follow. It simply reads my messy class notes, extracts the core algorithms, and connects everything in a broader conceptual framework. My study time cut in half while retention skyrocketed.",
                name: "Amina Bello",
              ...
              {
                quote: "LearnSync's AI takes personal lecture notes and GitHub repos and turns them into Leitner-spaced drills. It pinpoints edge cases and tricky concepts until they become second nature.",
                name: "Kofi Mensah",
              ...
              >
                <div>
                  <div className='flex text-amber-400 mb-4'>
                    {[...Array(5)].map((_, idx) => (
                      <FiStar key={idx} className='w-3.5 h-3.5 fill-amber-400 text-amber-400' />
                    ))}
                  </div>
                ...
                <div className='flex items-center gap-3 pt-4 border-t border-slate-100'>
                  <div className={`w-9 h-9 rounded-full ${test.color} text-white font-bold text-xs flex items-center justify-center shadow-xs`}>
                    {test.avatar}
                  </div>
                  <div>
      ...
      <section id='pricing' className='py-16 lg:py-24 bg-white border-t border-slate-100'>
        <div className='mx-auto max-w-7xl px-6'>
          ...
          >
            ...
            <p className='text-xs sm:text-sm text-slate-500 leading-relaxed font-normal'>
              Start free for your upcoming midterms and finals. Upgrade when you need unlimited note ingestion and advanced AI synthesis.
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch'>
            ...
            >
              <div>
                <h3 className='text-base font-bold text-slate-900 mb-1'>Student Starter</h3>
                <p className='text-xs text-slate-500 mb-4'>Essential for midterm exam cramming.</p>
                <div className='flex items-baseline gap-1 mb-6'>
                  <span className='text-3xl font-black text-slate-900'>$0</span>
                  <span className='text-xs text-slate-500'>/ semester free</span>
                </div>
            ...
            >
              ...
              <div>
                <h3 className='text-base font-bold text-white mb-1'>Pro Scholar</h3>
                <p className='text-xs text-slate-300 mb-4'>Full semester engineering dominance.</p>
                <div className='flex items-baseline gap-1 mb-6'>
                  <span className='text-3xl font-black text-white'>$9</span>
                  <span className='text-xs text-slate-400'>/ semester billing</span>
                </div>
            ...
            >
              <div>
                <h3 className='text-base font-bold text-slate-900 mb-1'>Lab &amp; Study Group</h3>
                <p className='text-xs text-slate-500 mb-4'>For project groups &amp; study teams.</p>
                <div className='flex items-baseline gap-1 mb-6'>
                  <span className='text-3xl font-black text-slate-900'>$19</span>
                  <span className='text-xs text-slate-500'>/ student / semester</span>
                </div>
      ...
      <section className='bg-[#070d1e] text-white py-16 lg:py-20'>
        <div className='mx-auto max-w-4xl px-6 text-center'>
          ...
          <p className='text-xs sm:text-sm text-slate-400 max-w-xl mx-auto mb-8 font-normal leading-relaxed'>
            Upload your lecture slides now and generate your first adaptive active-recall drill in under 60 seconds.
          </p>

          {/* Email input form */}
          <form onSubmit={handleEmailSubmit} className='max-w-md mx-auto flex flex-col sm:flex-row gap-2 mb-4'>
            <input
              type='email'
              value={emailInput}
      ...
      <footer className='bg-white pt-14 pb-10 border-t border-slate-100'>
        <div className='mx-auto max-w-7xl px-6'>
          <div className='grid grid-cols-2 md:grid-cols-5 gap-8 mb-12'>
            <div className='col-span-2'>
              ...
              <p className='text-xs text-slate-500 leading-relaxed max-w-xs mb-3'>
                Adaptive computer science learning designed for the next generation of software engineers. Academic excellence through cognitive science.
              </p>
            ...
            <div>
              ...
              <ul className='space-y-2.5 text-xs text-slate-500 font-medium'>
                <li><a href='#notes-engine' className='hover:text-slate-900 transition-colors'>AI Note Parsing</a></li>
                <li><a href='#notes-engine' className='hover:text-slate-900 transition-colors'>Broad Subject Synthesis</a></li>
                <li><a href='#notes-engine' className='hover:text-slate-900 transition-colors'>Multi-Format Slides &amp; PDF</a></li>
                <li><a href='#notes-engine' className='hover:text-slate-900 transition-colors'>Codebase AST Traversal</a></li>
                <li><a href='#notes-engine' className='hover:text-slate-900 transition-colors'>Concept Dependency Graphs</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className='space-y-2.5 text-xs text-slate-500 font-medium'>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Active Recall Engine</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Code Parser</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Exam Readiness Model</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Student Pricing</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Campus LMS Sync</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className='space-y-2.5 text-xs text-slate-500 font-medium'>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Academic Case Studies</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Cognitive Science Research</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Student Discord Community</a></li>
                <li><a href='#' className='hover:text-slate-900 transition-colors'>Privacy &amp; FERPA Compliance</a></li>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-slate-100 text-[11px] text-slate-400 font-medium'>
            <p>© 2026 LearnSync Adaptive Learning Technologies Inc. Calibrated for modern computing academia.</p>
            <div className='flex gap-4 mt-3 sm:mt-0'>
              ...
              <a href='#' className='hover:text-slate-600 transition-colors'>Terms &amp; Student Privacy</a>
            </div>
          </div>
        </div>
      </footer>
